...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= base_url() ?>web2/assets/plugins/fontawesome-free/css/all.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="<?= base_url() ?>web2/assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= base_url() ?>web2/assets/dist/css/adminlte.min.css">
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url() ?>web2/assets/index2.html"><b>Admin</b>Futsal</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
        ...
        <!-- jQuery -->
        <script src="<?= base_url() ?>web2/assets/plugins/jquery/jquery.min.js"></script>
        <!-- Bootstrap 4 -->
        <script src="<?= base_url() ?>web2/assets/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
        <!-- AdminLTE App -->
        <script src="<?= base_url() ?>web2/assets/dist/js/adminlte.min.js"></script>
