              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  <div class="chart tab-pane active" id="data-belumlunas"
                    ...
                    <form action="<?= base_url('dashboard/tmbhLap')?>" method="POST" enctype="multipart/form-data">
                      <div class="row">
                      <div class="form-group col-6 col-sm-6">
                        <label for="nama lapangan">Nama Lapangan</label>
                          <input type="hidden" name="id_lapangan" value="">
                          <input type="text" name="id_futsal" hidden value="<?= $this->session->userdata('id'); ?>">
                      ...
                      <div class="form-group col-6 col-sm-6">
                        ...
                        <div class="pt-3" style="border: 1px solid black; height: 74%; margin: auto; text-align: center;">
                            <p style="margin-top: 5%">
                              <input type="file" name="foto_lapangan"></input>
