                  ...
                  <?php if($this->session->userdata('level')=='1'){ ?>
                    ...
                    <div class="chart tab-pane active" id="data-belumlunas"
                     ...
                     <table class="table table-responsive">
                        <tr>
                          <th class="text-center" hidden>ID Booking</th>
                          <th class="text-center">ID Pengelola</th>
                          <th class="text-center">Nama Pengelola</th>
                          <th class="text-center">Telepon Pengelola</th>
                          <th class="text-center">Username Pengelola</th>
                          <th class="text-center">Email Pengelola</th>
                        </tr>

                        <?php 
                        
                          foreach($dataPengelola as $row){
                        ...
                        <tr>
                          ...
                          <td><?= $row->telp_pengelola; ?></td>
                          <td><?= $row->username_pengelola; ?></td>
                          <td><?= $row->email_pengelola; ?></td>
                          <!-- <td><?= $row->password_futsal; ?></td> -->
                        </tr>
                        <?php } ?>
                  ...
                  <div class="chart tab-pane active" id="data-belumlunas"
                     ...
                     <table class="table table-responsive">
                        <tr>
                          ...
                          <th class="text-center">Alamat Futsal</th>
                          <th class="text-center">Telepon Futsal</th>
                          <th class="text-center">Username Futsal</th>
                          <th class="text-center">Email Futsal</th>
                        </tr>

                        <?php 
                        
                          foreach($dataSatuOwner as $row){
