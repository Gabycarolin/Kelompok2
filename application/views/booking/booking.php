              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="#data-belumlunas" data-toggle="tab">Transaksi DP</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#data-lunas" data-toggle="tab">Transaksi Lunas</a>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
